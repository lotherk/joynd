...
const char *gengetopt_args_info_usage = "Usage: joy2key [OPTIONS]... [FILES]...";
...
const char *gengetopt_args_info_detailed_help[] = {
  ...
  "\nSee joy2key(1) for more informations and examples.",
    0
};
...
void clear_given (struct gengetopt_args_info *args_info)
{
  ...
  args_info->map_button_given = 0 ;
  args_info->map_axis_given = 0 ;
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->map_button_arg = NULL;
  args_info->map_button_orig = NULL;
  args_info->map_axis_arg = NULL;
  args_info->map_axis_orig = NULL;
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->log_file_help = gengetopt_args_info_detailed_help[4] ;
  args_info->verbose_help = gengetopt_args_info_detailed_help[5] ;
  args_info->list_help = gengetopt_args_info_detailed_help[7] ;
  args_info->input_help = gengetopt_args_info_detailed_help[8] ;
  args_info->debug_help = gengetopt_args_info_detailed_help[9] ;
  args_info->map_button_help = gengetopt_args_info_detailed_help[10] ;
  args_info->map_button_min = 0;
  args_info->map_button_max = 0;
  args_info->map_axis_help = gengetopt_args_info_detailed_help[11] ;
  args_info->map_axis_min = 0;
  args_info->map_axis_max = 0;
  args_info->daemon_help = gengetopt_args_info_detailed_help[12] ;
...
cmdline_parser_release (struct gengetopt_args_info *args_info)
{
  ...
  free_multiple_string_field (args_info->map_button_given, &(args_info->map_button_arg), &(args_info->map_button_orig));
  free_multiple_string_field (args_info->map_axis_given, &(args_info->map_axis_arg), &(args_info->map_axis_orig));
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  write_multiple_into_file(outfile, args_info->map_button_given, "map-button", args_info->map_button_orig, 0);
  write_multiple_into_file(outfile, args_info->map_axis_given, "map-axis", args_info->map_axis_orig, 0);
...
cmdline_parser_required2 (struct gengetopt_args_info *args_info, const char *prog_name, const char *additional_error)
{
  ...
  if (check_multiple_option_occurrences(prog_name, args_info->map_button_given, args_info->map_button_min, args_info->map_button_max, "'--map-button' ('-b')"))
     error_occurred = 1;
  
  if (check_multiple_option_occurrences(prog_name, args_info->map_axis_given, args_info->map_axis_min, args_info->map_axis_max, "'--map-axis' ('-a')"))
     error_occurred = 1;
  
  
  /* checks for dependences among options */
  if (args_info->map_button_given && ! args_info->input_given)
    {
      fprintf (stderr, "%s: '--map-button' ('-b') option depends on option 'input'%s\n", prog_name, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }
  if (args_info->map_axis_given && ! args_info->input_given)
    {
      fprintf (stderr, "%s: '--map-axis' ('-a') option depends on option 'input'%s\n", prog_name, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }
                        ...
                        struct cmdline_parser_params *params, const char *additional_error)
{
  ...
  struct generic_list * map_button_list = NULL;
  struct generic_list * map_axis_list = NULL;
  int error_occurred = 0;
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVL:v:li:Db:a:d", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'v':	/* Be more verbose. Can be specified multiple times to a maximum of 7.  */
          ...
          break;
        case 'l':	/* List all available joysticks and exit.  */
          ...
          break;
        case 'i':	/* Define joystick input number (0 is first, 1 is second, ...).  */
        
        
          if (update_arg( (void *)&(args_info->input_arg), 
               &(args_info->input_orig), &(args_info->input_given),
              &(local_args_info.input_given), optarg, 0, 0, ARG_INT,
              check_ambiguity, override, 0, 0,
              "input", 'i',
              additional_error))
            goto failure;
          ...
          break;
        case 'D':	/* Show debug informations.  */
          ...
          break;
        case 'b':	/* Map button number N to key KEY.  */
        
          if (update_multiple_arg_temp(&map_button_list, 
              &(local_args_info.map_button_given), optarg, 0, 0, ARG_STRING,
              "map-button", 'b',
              additional_error))
            goto failure;
        
          break;
        case 'a':	/* Map axis N to KEY.  */
        
          if (update_multiple_arg_temp(&map_axis_list, 
              &(local_args_info.map_axis_given), optarg, 0, 0, ARG_STRING,
              "map-axis", 'a',
              additional_error))
            goto failure;
        
          break;
        case 'd':	/* Fork into background.  */
  ...
  update_multiple_arg((void *)&(args_info->map_button_arg),
    &(args_info->map_button_orig), args_info->map_button_given,
    local_args_info.map_button_given, 0,
    ARG_STRING, map_button_list);
  update_multiple_arg((void *)&(args_info->map_axis_arg),
    &(args_info->map_axis_orig), args_info->map_axis_given,
    local_args_info.map_axis_given, 0,
    ARG_STRING, map_axis_list);

  args_info->map_button_given += local_args_info.map_button_given;
  local_args_info.map_button_given = 0;
  args_info->map_axis_given += local_args_info.map_axis_given;
  local_args_info.map_axis_given = 0;
...
failure:
  free_list (map_button_list, 1 );
  free_list (map_axis_list, 1 );
